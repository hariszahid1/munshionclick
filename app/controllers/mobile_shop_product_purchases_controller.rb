class MobileShopProductPurchasesController < ApplicationController
      ...
      respond_to do |format|
        if @purchase_sale_detail.save!
          ...
          if (params[:commit]=="Save" || params[:commit]=="Save with Print") && @purchase_sale_detail.transaction_type=='Sale'
            ...
            if @pos_setting.sys_type!="FastFood"
              format.html { redirect_to new_mobile_shop_product_purchase_path(transaction_type: :sale,product: true), notice: 'Sale was successfully created.' }
            else
            ...
            @ledger_book.save!
            format.html { redirect_to mobile_shop_product_purchases_path, notice: 'Purchase was successfully created.' }
          end
      ...
      respond_to do |format|
        ...
        if @purchase_sale_detail.update!(purchase_sale_detail_params)
          if @purchase_sale_detail.transaction_type=='Sale'
            ...
            format.html { redirect_to mobile_shop_product_purchases_path, notice: 'Purchase detail was successfully updated.' }
          end
