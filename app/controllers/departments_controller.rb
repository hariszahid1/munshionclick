class DepartmentsController < ApplicationController
  ...
  def index
    ...
    @custom_pagination = @pos_setting.custom_pagination['departments'] if @pos_setting&.custom_pagination.present? && @pos_setting&.custom_pagination['departments'].present?
